...
public class EventOrderController {
    ...
    public String getEventOrdersById(Model model, @PathVariable Long id) {
    ...
    public String deleteEventOrders(@PathVariable Long id) {
    ...
    public String updateEventOrders(@PathVariable Long id, Model model) {
